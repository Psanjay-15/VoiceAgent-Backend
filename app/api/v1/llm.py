...
SYSTEM_PROMPT = (
    ...
    "Do not re-ask details already provided. For meeting or calendar requests, cooperate and collect "
    "email only if needed. For unsupported document or contact-detail requests, say the team will follow up instead "
